...
class Style {
  ...
  static ThemeData theme3 = ThemeData(
    // Define the default brightness and colors.
    brightness: Brightness.light,
    primaryColor: Colors.black,
    colorScheme: ThemeData().colorScheme.copyWith(
  ...
  static changeStatusBarColor(Color backgroundColor) {
    bool dark = true;
    ...
    ).copyWith(systemNavigationBarColor: backgroundColor));
  }
  ...
  static Function(ThemeData data)? changeTheme;
}

class ThemeNotifier extends ValueNotifier<ThemeData> {
  ThemeNotifier({required ThemeData value}) : super(value);

  void change(ThemeData data) {
    value = data;
    Style.changeStatusBarColor(data.colorScheme.background);
  }
}
